...
The application SHALL serve a login form at `GET /admin/login` that accepts a password.
...
The application SHALL provide a logout mechanism at `GET /admin/logout` that clears the admin session.
